...
public class PassportController  extends BaseController{
    ...
    private void synchShopcartData(String userId, HttpServletRequest request,
        ...
        // 从redis中获取购物车
        String shopcartJsonRedis = redisOperator.get(FOODIE_SHOPCART + "_" + userId);
        ...
        if (StrUtil.isBlank(shopcartJsonRedis)) {
            ...
            if (StrUtil.isNotBlank(shopcartStrCookie)) {
                redisOperator.set(FOODIE_SHOPCART + "_" + userId, shopcartStrCookie);
            }
        } else {
            ...
            if (StrUtil.isNotBlank(shopcartStrCookie)) {
                ...
                redisOperator.set(FOODIE_SHOPCART + "_" + userId, JsonUtils.objectToJson(shopcartListRedis));
            } else {
