...
`Explain` 执行计划包含字段信息如下：分别是 `id`、`select_type`、`table`、`partitions`、`type`、`possible_keys`、`key`、`key_len`、`ref`、`rows`、`filtered`、`Extra` 12个字段。 ![img](https://user-gold-cdn.xitu.io/2020/5/20/172311d20c534c4b?imageView2/0/w/1280/h/960/format/webp/ignore-error/1) 下边我们会结合具体的`SQL`示例，详细的解读每个字段以及每个字段中不同参数的含义，以下所有示例数据库版本为 `MySQL.5.7.17`。
...
作者：程序员内点事
链接：https://juejin.cn/post/6844904163969630221
来源：掘金
